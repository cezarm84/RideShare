...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Create an admin user for the RideShare application")
    parser.add_argument("--email", default="admin@rideshare.com", help="Admin email address")
