...
from app.models.hub import Hub  # Changed from location.py
from app.models.location import Location  # Keep this import
...
if __name__ == "__main__":
    proceed = input("This will DELETE ALL DATA in your database. Type 'yes' to proceed: ")
