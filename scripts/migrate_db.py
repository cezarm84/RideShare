...
def main():
    ...
    apply_parser.add_argument("--revision", help="Specific revision to migrate to", default="head")
    
    # Rollback migrations
    rollback_parser = subparsers.add_parser("rollback", help="Rollback migrations")
    rollback_parser.add_argument("--revision", help="Revision to rollback to", default="-1")
