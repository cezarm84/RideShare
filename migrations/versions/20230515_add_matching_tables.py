...
def upgrade():
    ...
    op.add_column(
        "users", sa.Column("preferred_starting_hub_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("preferred_vehicle_type_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "users",
        sa.Column(
    ...
    op.add_column(
        "users",
        sa.Column(
            "max_detour_minutes", sa.Integer(), nullable=True, server_default="15"
        ),
    )
    op.add_column(
        "users",
    ...
    op.create_foreign_key(
        "fk_users_preferred_hub", "users", "hubs", ["preferred_starting_hub_id"], ["id"]
    )
    op.create_foreign_key(
        "fk_users_preferred_vehicle_type",
        "users",
        "vehicle_types",
    ...
    op.create_index(
        op.f("ix_user_travel_patterns_id"), "user_travel_patterns", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_user_travel_patterns_user_id"),
        "user_travel_patterns",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "minimum_driver_rating", sa.Float(), nullable=True, server_default="4.0"
        ),
        sa.Column(
            "prefer_same_enterprise", sa.Boolean(), nullable=True, server_default="1"
        ),
        sa.Column(
            "prefer_same_destination", sa.Boolean(), nullable=True, server_default="1"
        ),
        sa.Column(
            "prefer_recurring_rides", sa.Boolean(), nullable=True, server_default="1"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_index(
        op.f("ix_ride_match_history_id"), "ride_match_history", ["id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_user_travel_patterns_user_id"), table_name="user_travel_patterns"
    )
