...
def upgrade() -> None:
    ...
    op.add_column(
        "ride_bookings", sa.Column("passenger_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "ride_bookings", sa.Column("seats_booked", sa.Integer(), nullable=True)
    )
    op.add_column(
        "ride_bookings", sa.Column("booking_status", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "ride_bookings", sa.Column("created_at", sa.DateTime(), nullable=True)
    )
    op.alter_column(
        "ride_bookings", "ride_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.drop_constraint(None, "ride_bookings", type_="foreignkey")
    op.drop_constraint(None, "ride_bookings", type_="foreignkey")
    op.create_foreign_key(None, "ride_bookings", "users", ["passenger_id"], ["id"])
    op.create_foreign_key(
        None, "ride_bookings", "rides", ["ride_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.alter_column(
        "rides", "available_seats", existing_type=sa.INTEGER(), nullable=True
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "rides", "available_seats", existing_type=sa.INTEGER(), nullable=False
    )
    ...
    op.add_column(
        "ride_bookings", sa.Column("passenger_count", sa.INTEGER(), nullable=False)
    )
    op.add_column(
        "ride_bookings", sa.Column("booking_time", sa.DATETIME(), nullable=True)
    )
    ...
    op.alter_column(
        "ride_bookings", "ride_id", existing_type=sa.INTEGER(), nullable=False
    )
    ...
    op.alter_column("payments", "status", existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column(
        "payments", "booking_id", existing_type=sa.INTEGER(), nullable=False
    )
    ...
    op.create_index(
        "ix_message_attachments_id", "message_attachments", ["id"], unique=False
    )
    # ### end Alembic commands ###
