...
def upgrade():
    ...
    with op.batch_alter_table('rides') as batch_op:
        batch_op.add_column(sa.Column('origin_location_id', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('destination_location_id', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('fk_ride_origin_location', 'locations', ['origin_location_id'], ['id'])
        batch_op.create_foreign_key('fk_ride_destination_location', 'locations', ['destination_location_id'], ['id'])
