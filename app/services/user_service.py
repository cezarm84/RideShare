...
class UserService:
    ...
    def create_user(self, user_in: UserCreate, user_id=None, home_location=None, work_location=None) -> User:
        ...
        try:
            ...
            if user_in.home_address and not latitude and not longitude:
                ...
                latitude = 59.3293
                longitude = 18.0686
                logger.info(f"Using default coordinates for home address: {latitude}, {longitude}")
            ...
            if user_in.work_address and not work_latitude and not work_longitude:
                ...
                logger.info(f"Using default coordinates for work address: {work_latitude}, {work_longitude}")
    ...
    def update_user(self, user_id: int, user_update: UserUpdate) -> User:
        ...
        if "home_address" in update_data and update_data["home_address"]:
            ...
            logger.info(f"Using default coordinates for updated home address: {update_data['latitude']}, {update_data['longitude']}")
        ...
        if "work_address" in update_data and update_data["work_address"]:
            ...
            logger.info(f"Using default coordinates for updated work address: {update_data['work_latitude']}, {update_data['work_longitude']}")
    ...
    async def update_user_async(self, user_id: int, user_update: UserUpdate) -> User:
        ...
        if "home_address" in update_data and update_data["home_address"]:
            try:
                ...
                latitude, longitude = await get_coordinates_safely(update_data["home_address"])
                update_data["latitude"] = latitude
                update_data["longitude"] = longitude
                logger.info(f"Successfully geocoded updated home address to: {latitude}, {longitude}")
            except Exception as e:
        ...
        if "work_address" in update_data and update_data["work_address"]:
            try:
                # Properly await the geocoding function
                work_latitude, work_longitude = await get_coordinates_safely(update_data["work_address"])
                update_data["work_latitude"] = work_latitude
                update_data["work_longitude"] = work_longitude
                logger.info(f"Successfully geocoded updated work address to: {work_latitude}, {work_longitude}")
            except Exception as e:
    ...
    async def create_user_async(self, user_in: UserCreate, user_id=None) -> User:
        ...
        try:
            ...
            if user_in.home_address and not latitude and not longitude:
                try:
                    # Properly await the geocoding function
                    latitude, longitude = await get_coordinates_safely(user_in.home_address)
                    logger.info(f"Successfully geocoded home address to: {latitude}, {longitude}")
                except Exception as e:
            ...
            if user_in.work_address and not work_latitude and not work_longitude:
                try:
                    # Properly await the geocoding function
                    work_latitude, work_longitude = await get_coordinates_safely(user_in.work_address)
                    logger.info(f"Successfully geocoded work address to: {work_latitude}, {work_longitude}")
                except Exception as e:
...
def create_user(db: Session, user: UserCreate | dict, user_id=None, home_location=None, work_location=None) -> User:
    ...
    try:
        ...
        logger.info(f"User created successfully: ID={db_user.id}, user_id={db_user.user_id}, name={db_user.first_name} {db_user.last_name}")
...
async def create_user_async(db: Session, user: UserCreate | dict, user_id=None) -> User:
    ...
    try:
        ...
        # Log successful user creation
        logger.info(f"User created successfully (async): ID={db_user.id}, user_id={db_user.user_id}, name={db_user.first_name} {db_user.last_name}")
...
def update_user(db: Session, user_id: int, user_update: UserUpdate) -> User:
    ...
    try:
        ...
        logger.info(f"User updated successfully: ID={updated_user.id}, name={updated_user.first_name} {updated_user.last_name}")
...
async def update_user_async(db: Session, user_id: int, user_update: UserUpdate) -> User:
    ...
    try:
        ...
        # Log successful update
        logger.info(f"User updated successfully (async): ID={updated_user.id}, name={updated_user.first_name} {updated_user.last_name}")
