...
class AddressInfo(BaseModel):
    ...
    coordinates: Optional[CoordinatesModel] = Field(None, description="Geographical coordinates")
...
class LocationBase(BaseModel):
    ...
    type: Optional[str] = Field(None, description="Type of location (business, park, etc.)")
...
class LocationResponse(LocationBase):
    ...
    created_at: Optional[datetime] = Field(None, description="When the location was created")
    updated_at: Optional[datetime] = Field(None, description="When the location was last updated")
...
class HubResponse(HubBase):
    ...
    updated_at: Optional[datetime] = Field(None, description="When the hub was last updated")
